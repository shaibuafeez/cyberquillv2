...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      {/* Bottom fixed div */}
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-xl bg-[#323131] flex justify-around items-center z-50 rounded-3xl text-xs">
